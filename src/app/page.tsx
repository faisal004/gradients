...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center  p-8">
      <h1 className="text-black dark:text-white  text-3xl font-bold text-center mb-8">Complete Gradient Collection</h1>
      <ThemeToggle />
    
      {/* Your Original Examples */}
      <div className="mb-12">
        <h2 className="text-black dark:text-white text-xl mb-4">Your Original Examples</h2>
      ...
      {/* Linear Gradients */}
      <div className="mb-12">
        <h2 className="text-black dark:text-white text-xl mb-4">Linear Gradients</h2>
        <div className="flex flex-wrap gap-4 justify-center">
      ...
      {/* Conic Gradients */}
      <div className="mb-12">
        <h2 className="text-black dark:text-white text-xl mb-4">Conic Gradients</h2>
        <div className="flex flex-wrap gap-4 justify-center">
      ...
      <div className="mb-12">
        <h2 className="text-black dark:text-white text-xl mb-4">Advanced Radial Gradients</h2>
        <div className="flex flex-wrap gap-4 justify-center">
      ...
      {/* Repeating Gradients */}
      <div className="mb-12">
        <h2 className="text-black dark:text-white text-xl mb-4">Repeating Gradients</h2>
        <div className="flex flex-wrap gap-4 justify-center">
      ...
      <div className="mb-12">
        <h2 className="text-black dark:text-white text-xl mb-4">Multi-Stop Complex Gradients</h2>
        <div className="flex flex-wrap gap-4 justify-center">
      ...
      <div className="mb-12">
        <h2 className="text-black dark:text-white text-xl mb-4">Mesh/Glass Effect Gradients</h2>
        <div className="flex flex-wrap gap-4 justify-center">
      ...
      {/* Animated Gradients */}
      <div className="mb-12">
        <h2 className="text-black dark:text-white text-xl mb-4">Interactive Gradients</h2>
        <div className="flex flex-wrap gap-4 justify-center">
      ...
      <div className="mb-12">
        <h2 className="text-black dark:text-white text-xl mb-4">Custom Complex Patterns</h2>
        <div className="flex flex-wrap gap-4 justify-center">
      ...
      <div className="mb-12">
        <h2 className="text-black dark:text-white text-xl mb-4">Precise Color Stops</h2>
        <div className="flex flex-wrap gap-4 justify-center">
