...
export const GRADIENT_PRESETS: GradientPreset[] = [
  ...
  preset("bone-china", "Bone China", "Warm porcelain, lit from the corner of a quiet room.", { from: "#fffdf8", via: "#f3eadc", to: "#e4d6c4", addVia: true, gradientType: "radial", radialShape: "ellipse", shapePosition: { x: 26, y: 20 }, viaPercentage: 54 }, { type: "none" }),
  preset("champagne-mist", "Champagne Mist", "Dusty gold that stays pale, like silk in afternoon light.", { from: "#fbf8f1", via: "#eadfc4", to: "#d4c4a4", addVia: true, direction: "bottom right", viaPercentage: 50 }, { type: "none" }),
  preset("studio-fog", "Studio Fog", "Cool product grey, like a quiet hardware page.", { from: "#f5f5f7", via: "#ebebef", to: "#d8d8de", addVia: true, gradientType: "radial", radialShape: "ellipse", shapePosition: { x: 30, y: 18 }, viaPercentage: 52 }, { type: "none" }),
  preset("frosted-glass", "Frosted Glass", "Cool, barely tinted, like light through sandblasted glass.", { from: "#f8f9fb", via: "#e4eaf0", to: "#c5d0dc", addVia: true, gradientType: "radial", radialShape: "ellipse", shapePosition: { x: 36, y: 28 }, viaPercentage: 52 }, { type: "none" }),
  ...
  preset("blush-stone", "Blush Stone", "Dusty blush that never tips into candy.", { from: "#f7f1ee", via: "#e5d4ce", to: "#c8b2aa", addVia: true, direction: "bottom right", viaPercentage: 48 }, { type: "none" }),
  preset("cashmere", "Cashmere", "Camel and taupe, held in a narrow range.", { from: "#eadcc8", via: "#d0b088", to: "#b08964", addVia: true, direction: "bottom", viaPercentage: 48 }, { type: "none" }),
  preset("olive-silk", "Olive Silk", "Muted leaf and plaster, no black at the bottom.", { from: "#e6e2ce", via: "#b0b08c", to: "#7e8064", addVia: true, direction: "bottom right", viaPercentage: 46 }, { type: "none" }),
  preset("raw-clay", "Raw Clay", "Dusty terracotta, dried rather than fired.", { from: "#d4a088", via: "#b07860", to: "#8a5848", addVia: true, direction: "bottom right", viaPercentage: 48 }, { type: "none" }),
  preset("oxblood", "Oxblood", "Desaturated burgundy. Old leather, not a nightclub.", { from: "#5c383c", via: "#3a2426", to: "#1a1414", addVia: true, gradientType: "radial", radialShape: "ellipse", shapePosition: { x: 34, y: 26 }, viaPercentage: 46 }, { type: "none" }),
  preset("aged-cognac", "Aged Cognac", "Warm leather, kept in the mid-browns.", { from: "#9a7054", via: "#7a5440", to: "#5a382c", addVia: true, direction: "bottom right", viaPercentage: 50 }, { type: "none" }),
  preset("quiet-indigo", "Quiet Indigo", "Deep indigo with no glow and no grid.", { from: "#2a2448", via: "#14121e", to: "#08070d", addVia: true, gradientType: "radial", radialShape: "ellipse", shapePosition: { x: 42, y: 8 }, viaPercentage: 36 }, { type: "none" }),
  preset("ink-wash", "Ink Wash", "Lifted charcoal, like diluted sumi on cold paper.", { from: "#4a5260", via: "#2c3038", to: "#121416", addVia: true, gradientType: "radial", radialShape: "ellipse", shapePosition: { x: 70, y: 14 }, viaPercentage: 44 }, { type: "none" }),
  preset("soft-obsidian", "Soft Obsidian", "Warm black. Almost no color, on purpose.", { from: "#2c2824", via: "#161412", to: "#0b0a09", addVia: true, gradientType: "radial", radialShape: "ellipse", shapePosition: { x: 40, y: 26 }, viaPercentage: 50 }, { type: "none" }),
];
